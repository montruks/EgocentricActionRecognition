...
class VideoModel(nn.Module):
    ...
    def _prepare_DA(self, num_class, base_model):  # convert the model to DA framework
        if base_model == 'c3d':  # C3D mode: in construction...
            ...
            model_test = I3D(num_class=num_class, modality=self.modality, model_config=self.conv_fusion)
    ...
    def domain_classifier_frame(self, feat, beta):  # GSD
    ...
    def domain_classifier_video(self, feat_video, beta):  # GVD
    ...
    def domain_classifier_relation(self, feat_relation, beta):  # GRD
        # 128x4x256 --> (128x4)x2
